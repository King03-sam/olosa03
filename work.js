// Par OLOJEDE Samuel /by OLOJEDE Samuel 
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (window.emailjs) {
                ...
                if (formMessage) {
                    formMessage.textContent = "Erreur: EmailJS n'est pas disponible";
                    formMessage.classList.remove('hidden', 'bg-green-100', 'text-green-600');
                    formMessage.classList.add('bg-red-100', 'text-red-600', 'animate__animated', 'animate__shakeX');
                }
                if (btnText) btnText.textContent = 'Envoyer le message';
...
function setupDarkModeToggle() {
    ...
    if (darkModeToggle) {
        try {
            ...
            console.warn("Erreur lors de l'initialisation du dark mode:", e);
        }
    }
}
